...
module medusa_light
   ...
   type, extends(type_base_model), public :: type_medusa_light
      ...
      type (type_surface_dependency_id)             :: id_qsr
...
contains
   ...
   subroutine initialize(self, configunit)
      ...
      call self%register_dependency(self%id_ZCHN,'CHN','mg chl/m**3', 'chlorophyll in non-diatoms')
      call self%register_dependency(self%id_ZCHD,'CHD','mg chl/m**3', 'chlorophyll in diatoms')
