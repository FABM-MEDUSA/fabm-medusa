...
module gas_transfer
   ...
   type, extends(type_base_model), public :: type_gas_transfer
      ...
      type (type_surface_dependency_id)          :: id_wnd
...
contains
   ...
   subroutine initialize(self, configunit)
      ...
      call self%get_parameter(self%eqn,'eqn','-','choice of gas transfer coefficients', default = 7, minimum=1, maximum=7)
