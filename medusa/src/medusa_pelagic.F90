...
contains
   ...
   call self%register_diagnostic_variable(self%id_prn,'PRN','mmolN/m3/d','Non-diatom primary production',output=output_none)
   call self%register_diagnostic_variable(self%id_prd,'PRD','mmolN/m3/d','Diatom primary production',output=output_none)
   call self%register_diagnostic_variable(self%id_mpn,'MPN','mmolN/m3/d','Non-diatom non-grazing losses',output=output_none)
   call self%register_diagnostic_variable(self%id_mpd,'MPD','mmolN/m3/d','Diatom non-grazing losses',output=output_none)
   call self%register_diagnostic_variable(self%id_OPAL,'OPAL','mmolSi/m3/d','Diatom biogenic opal production',output=output_none)
   call self%register_diagnostic_variable(self%id_OPALDISS,'OPALDISS','mmolSi/m3/d','Diatom biogenic opal dissolution',output=output_none)
   call self%register_diagnostic_variable(self%id_GMIPn,'GMIPn','mmolN/m3/d','Microzoo grazing on non-diatoms',output=output_none)
   call self%register_diagnostic_variable(self%id_GMID,'GMID','mmolN/m3/d','Microzoo grazing on detritus',output=output_none)
   call self%register_diagnostic_variable(self%id_GMEPN,'GMEPN','mmolN/m3/d','Mesozoo grazing on non-diatoms',output=output_none)
   call self%register_diagnostic_variable(self%id_GMEPD,'GMEPD','mmolN/m3/d','Mesozoo grazing on diatoms',output=output_none)
   call self%register_diagnostic_variable(self%id_GMEZMI,'GMEZMI','mmolN/m3/d','Mesozoo grazing on microzoo',output=output_none)
   call self%register_diagnostic_variable(self%id_GMED,'GMED','mmolN/m3/d','Mesozoo grazing on detritus',output=output_none)
   call self%register_diagnostic_variable(self%id_MZMI,'MZMI','mmolN/m3/d','Microzoo non-grazing losses',output=output_none)
   call self%register_diagnostic_variable(self%id_MZME,'MZME','mmolN/m3/d','Mesozoo non-grazing losses',output=output_none)
   call self%register_diagnostic_variable(self%id_detn,'DETN','mmolN/m3/d','Slow detritus creation',output=output_none)
   call self%register_diagnostic_variable(self%id_detc,'DETC','mmolC/m3/d','Slow detritus C creation',output=output_none)
   call self%register_diagnostic_variable(self%id_MDET,'MDET','mmolN/m3/d','Detritus non-grazing losses',output=output_none)
   call self%register_diagnostic_variable(self%id_MDETC,'MDETC','mmolC/m3/d','Detritus non-grazing losses, carbon',output=output_none)
   ...
   call self%register_diagnostic_variable(self%id_pd_nlim,'PD_NLIM','-','Diatom N limitation',output=output_none)
   call self%register_diagnostic_variable(self%id_pd_felim,'PD_FELIM','-','Diatom Fe limitation',output=output_none)
   call self%register_diagnostic_variable(self%id_pd_silim,'PD_SILIM','-','Diatom Si limitation',output=output_none)
   call self%register_diagnostic_variable(self%id_pd_silim2,'PD_SILIM2','-','Diatom Si uptake limitation',output=output_none)
   call self%register_diagnostic_variable(self%id_pn_jlim,'PN_JLIM','-','Non-diatom light limitation',output=output_none)
   call self%register_diagnostic_variable(self%id_pn_nlim,'PN_NLIM','-','Non-diatom N limitation',output=output_none)
   call self%register_diagnostic_variable(self%id_pn_felim,'PN_FELIM','-','Non-diatom Fe limitation',output=output_none)
   call self%register_diagnostic_variable(self%id_PN_LLOSS,'PN_LLOSS','mmolN/m3/d','Non-diatom linear losses',output=output_none)
   call self%register_diagnostic_variable(self%id_PD_LLOSS,'PD_LLOSS','mmolN/m3/d','Diatom linear losses',output=output_none)
   call self%register_diagnostic_variable(self%id_ZI_LLOSS,'ZI_LLOSS','mmolN/m3/d','Microzooplankton linear losses',output=output_none)
   call self%register_diagnostic_variable(self%id_ZE_LLOSS,'ZE_LLOSS','mmolN/m3/d','Mesozooplankton linear losses',output=output_none)
   call self%register_diagnostic_variable(self%id_ZI_MES_N,'ZI_MES_N','mmolN/m3/d','Microzoo messy feeding loss to N',output=output_none)
   call self%register_diagnostic_variable(self%id_ZI_MES_D,'ZI_MES_D','mmolN/m3/d','Microzoo messy feeding loss to D',output=output_none)
   call self%register_diagnostic_variable(self%id_ZI_MES_C,'ZI_MES_C','mmolC/m3/d','Microzoo messy feeding loss to C',output=output_none)
   call self%register_diagnostic_variable(self%id_ZI_MESDC,'ZI_MESDC','mmolC/m3/d','Microzoo messy feeding loss to Dc',output=output_none)
   call self%register_diagnostic_variable(self%id_ZE_MES_N,'ZE_MES_N','mmolN/m3/d','Mesozoo messy feeding loss to N',output=output_none)
   call self%register_diagnostic_variable(self%id_ZE_MES_D,'ZE_MES_D','mmolN/m3/d','Mesozoo messy feeding loss to D',output=output_none)
   call self%register_diagnostic_variable(self%id_ZE_MES_C,'ZE_MES_C','mmolC/m3/d','Mesozoo messy feeding loss to C',output=output_none)
   call self%register_diagnostic_variable(self%id_ZE_MESDC,'ZE_MESDC','mmolC/m3/d','Mesozoo messy feeding loss to Dc',output=output_none)
   call self%register_diagnostic_variable(self%id_ZI_EXCR,'ZI_EXCR','mmolN/m3/d','Microzoo excretion',output=output_none)
   call self%register_diagnostic_variable(self%id_ZI_RESP,'ZI_RESP','mmolN/m3/d','Microzoo respiration',output=output_none)
   call self%register_diagnostic_variable(self%id_ZI_GROW,'ZI_GROW','mmolN/m3/d','Microzoo growth',output=output_none)
   call self%register_diagnostic_variable(self%id_ZE_EXCR,'ZE_EXCR','mmolN/m3/d','Mesozoo excretion',output=output_none)
   call self%register_diagnostic_variable(self%id_C_PROD,'C_PROD','mmolC/m3/d','Carbon production',output=output_none)
   call self%register_diagnostic_variable(self%id_C_CONS,'C_CONS','mmolC/m3/d','Carbon consumption',output=output_none)
   call self%register_diagnostic_variable(self%id_N_PROD,'N_PROD','mmolN/m3/d','Nitogen production',output=output_none)
   call self%register_diagnostic_variable(self%id_N_CONS,'N_CONS','mmolN/m3/d','Nitrogen consumption',output=output_none)
   call self%register_diagnostic_variable(self%id_foxy_prod,'O2_PROD','mmolO2/m3/d','Oxygen production',output=output_none)
   call self%register_diagnostic_variable(self%id_foxy_cons,'O2_CONS','mmolO2/m3/d','Oxygen consumption',output=output_none)
   call self%register_diagnostic_variable(self%id_foxy_anox,'O2_ANOX','mmolO2/m3/d','Unrealised oxygen consumption',missing_value=0.0_rk,output=output_none)
   call self%register_diagnostic_variable(self%id_ZE_RESP,'ZE_RESP','mmolN/m3/d','Mesozoo respiration',output=output_none)
   call self%register_diagnostic_variable(self%id_ZE_GROW,'ZE_GROW','mmolN/m3/d','Mesozoo growth',output=output_none)
   call self%register_diagnostic_variable(self%id_fcomm_resp,'fcomm_resp','mmolC/m3/d','Community respiration',output=output_none)
   ...
   call self%register_diagnostic_variable(self%id_FASTN,'FASTN','mmol N/m**3', 'fast-sinking detritus (N)',output=output_none)
   call self%register_diagnostic_variable(self%id_FASTC,'FASTC','mmol C/m**3', 'fast-sinking detritus (C)',output=output_none)
